...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter{
   ...
   public JwtAuthorizationFilter(AuthenticationManager authManager,UsersRepository userRepository ) {
		super(authManager);	
...
// 			Optional <MembersEntity> opt = userRepository.findById(username);
// 			MembersEntity  memEntity = opt.get();
 			UsersDTO user = UsersDTO.toDTO(userEntity);
